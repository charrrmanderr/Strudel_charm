...
// BASS
const bass = note("<c2 e2 f2 c3 g2 [b2 c3] e2 [g3 e3 d3 c3]>")
  .sound("gm_lead_6_voice:2")
  // .gain("1.5")
  .phaser(8)
  .distort(2)
  .layer(
  ...
  .attack("0.15")
  // .struct("<x!4 x [x x] [x x] [[x x - x] [x - x x@2 x - x]@2 [x x]]>")
  // .ply("<1 [1|2] 1 [1|2|6]>")
...
const chord_pattern = (["<[d4,e4,g4,c5] e4 g4 [d4,e4,g4,c5] - e4 g4 [d4,e4,g4,c5] - e4 g4 [d4,e4,g4,c5] - e4 [d4,g4,a4,b4] ->*8",
                        "<[c4,f4,g4,a4] e4 g4 [c4,f4,g4,a4] - e4 g4 [c4,f4,g4,a4] - e4 g4 [c4,f4,g4,a4] - e4 [c4,e4,f4,g4] ->*8",
                        "<[d4,g4,a4,b4] e4 g4 [d4,g4,a4,b4] - e4 g4 [d4,g4,a4,b4] - e4 g4 [d4,g4,a4,b4] - e4 [d4,g4,a4,b4] ->*8",
                        "<[d4,e4,g4,b4] e4 g4 [d4,e4,g4,b4] - e4 g4 [d4,e4,g4,b4] - e4 g4 [d4,e4,g#4,b4] - e4 [d4,e4,g#4,b4] ->*8",
                        "<[e4,a4,g4,c5] e4 g4 [e4,a4,g4,c5] - e4 g4 [e4,a4,f4,c5] - e4 g4 [e4,a4,f4,c5] - e4 [g4,a4,b4,d4] ->*8"])
...
// 3: Em7 - E7
// 4: Am9
$: note("<0 <[1 4] 1> 2 3>/2".pick(chord_pattern)).sound("gm_music_box").crush(slider(8,4,8))
.color("white")._pitchwheel({'height':300, 'width':300})

const pattern =  ["{[d4,e4,g4,c5] e4 g4 [d4,e4,g4,c5] - e4 g4 [d4,e4,g4,c5] - e4 g4 [d4,e4,g4,c5] - e4 [d4,g4,a4,b4] -}%2",
                  "{[c4,f4,g4,a4] e4 g4 [c4,f4,g4,a4] - e4 g4 [c4,f4,g4,a4] - e4 g4 [c4,f4,g4,a4] - e4 [c4,e4,f4,g4] -}%2",
                  "{[d4,g4,a4,b4] e4 g4 [d4,g4,a4,b4] - e4 g4 [d4,g4,a4,b4] - e4 g4 [d4,g4,a4,b4] - e4 [d4,g4,a4,b4] -}%2",
                  "{[d4,e4,g4,b4] e4 g4 [d4,e4,g4,b4] - e4 g4 [d4,e4,g4,b4] - e4 g4 [d4,e4,g#4,b4] - e4 [d4,e4,g#4,b4] -}%2",
                  "{[e4,a4,g4,c5] e4 g4 [e4,a4,g4,c5] - e4 g4 [e4,a4,f4,c5] - e4 g4 [e4,a4,f4,c5] - e4 [g4,a4,b4,d4] -}%2"]

ARP: note(pick("<0!2 <[1 4] 1>!2 2!2 3!2>/8", pattern)).fast(8).s("sine,supersaw").scale("C4:Major")
  // .add(note("<0 12>*1.5")) // .sometimesBy(0.3, ply("2"))
  .sometimesBy(0.4, off(1/16, x=>x.add(note(12))))
  .delay("0.5")
  .legato(slider(0.3, 0.3, 0.8))
  .gain("1".mul(lvl))
  .color('aqua')
  .distort(1)
...
DRUMS: stack(
  s("bd:0*4").bank("RolandTR909").distort(1),
  s("- cp").fast(2).bank("RolandTR707"),
  s("sh!16").bank("RolandTR808").attack("0.1"),
  s("bd:6").struct("<x - x(3,8,0)@2 x - [- x] [- <x [- x]>]>*4").bank("tr909"),
  s("- hh").fast(8).gain("0.5")
  ).room(0.5)
